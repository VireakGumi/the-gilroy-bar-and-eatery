...
“Margaret is a neighbourhood restaurant, but it’s also evolved into something more than that. At its core, it’s about comfort, generosity and cosiness.” — Neil Perry',
                'view_detail' => ['30-36 Bay St, Double Bay NSW', '(02) 9068 8888'],
                'view_menu' => ['storage/pdf/menu/gilroy_Downstairs-A3_Aug25_v2.pdf', 'storage/pdf/menu/gilroy_Menu_A5_Set-Menu-65PP.pdf'],
                'detail_page' => []
            ],
            'Next Door' => [
                'img' => 'images/venues2.png',
                'short_desc' => 'A walk-in wine bar with a rolling 12-hour lunch-to-dinner menu that includes the famous Perry hamburger and small plates for sharing.',
                'desc' => 'Margaret has proudly been named the No. 2 Steak Restaurant in the World and No. 1 in Australia for 2025 - a reflection of our uncompromising commitment to excellence in both produce and hospitality.
...
“Margaret is a neighbourhood restaurant, but it’s also evolved into something more than that. At its core, it’s about comfort, generosity and cosiness.” — Neil Perry',
                'view_detail' => ['30-36 Bay St, Double Bay NSW 2028', '(02) 9068 8888'],
                'view_menu' => ['storage/pdf/menu/gilroy_Downstairs-A3_Aug25_v2.pdf', 'storage/pdf/menu/gilroy_Menu_A5_Set-Menu-65PP.pdf'],
                'detail_page' => []
            ],
            'Gran Torino' => [
                'img' => 'images/venues3.png',
                'short_desc' => 'Introducing Gran Torino – a modern Italian ristorante and bar by Neil Perry, located in the heart of Double Bay.',
                'desc' => 'Margaret has proudly been named the No. 2 Steak Restaurant in the World and No. 1 in Australia for 2025 - a reflection of our uncompromising commitment to excellence in both produce and hospitality.
...
“Margaret is a neighbourhood restaurant, but it’s also evolved into something more than that. At its core, it’s about comfort, generosity and cosiness.” — Neil Perry',
                'view_detail' => ['24 Bay St, Double Bay NSW', '(02) 9871 9888'],
                'view_menu' => ['storage/pdf/menu/gilroy_Downstairs-A3_Aug25_v2.pdf', 'storage/pdf/menu/gilroy_Menu_A5_Set-Menu-65PP.pdf'],
                'detail_page' => []
            ],
        ];
