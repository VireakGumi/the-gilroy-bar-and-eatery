...
@section('content')
    <div style="venues-section">
        <div class="p-4 text-start"
            ...
            <div class="container p-0">
                ...
                <h2 class="fw-normal" style="font-family: 'columbiasans-light', serif; line-height: 1.1; width: 65%;">
                    Gathering friends and family is always a joy. Whether it's a wedding, birthday, homecoming, corporate
                    event
        ...
        <div class="container p-0 py-5 d-flex justify-content-center">
            <div class="row w-100 justify-content-between" style="max-width: 1700px;">
                @foreach ($details as $key => $detail)
                    ...
                    <div class="{{ $isLastOdd ? 'col-lg-6 col-md-12' : 'col-lg-6 col-md-12'}} px-4">
                        <!-- Image -->
                        <img src="{{ asset($detail['img']) }}" alt="{{ $key }} Dish"
                            class="venue-img w-100 rounded-0 shadow-sm mb-4">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <a href="{{ $detail['location'] }}" target="_blank"
                                class=" small fw-semibold text-dark venue-link">View
                                Venue</a>
                        </div>
                        ...
                        <div class="accordion border-0" id="venueAccordion_{{ $loop->index }}">
                            <div class="accordion-item border-0 border-bottom">
                                ...
                                <div id="collapseDetails_{{ $loop->index }}" class="accordion-collapse collapse"
                                    style="background-color:#fbf9f4;" aria-labelledby="headingDetails_{{ $loop->index }}"
