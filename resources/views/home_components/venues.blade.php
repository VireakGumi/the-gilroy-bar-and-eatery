   ...
   With dishes that change daily depending on the finest seasonal ingredients available to us, Gilroy is a dynamic expression of produce, craft, and care - where the best ingredients, wines, and service come together in a truly memorable dining experience.
   Gilroy is named after Neil Perry’s late mother who was the matriarch of the family, the nurturer and carer, and the one who held everyone together. These wonderful qualities became the inspiration behind the CARE philosophy that Neil created; caring for our suppliers, each other, the community and environment, which he has applied throughout his entire career as a chef and restaurateur.
   “Gilroy is a neighbourhood restaurant, but it’s also evolved into something more than that. At its core, it’s about comfort, generosity and cosiness.” — Neil Perry',
   'view_detail' => [
   '317 Bay Street Port Melbourne Vic 3207' => 'https://share.google/edApN1GnFWOlvxEol',
   '(03) 9810 1222' => 'tel:(03) 9810 1222',
   ],
   'view_menu' => [
   ...
   <div class="venues-section">
       <div class="p-4 text-start"
           ...
           <h2 class="fw-normal" style="font-family: 'columbiasans-light', serif; line-height: 1.1;">
               A whole day could be spent in the Gilroy Bar & Eatery dining precinct, from a
               <span class="fw-semibold">morning</span> coffee and breakfast roll or a linger-longer lunch at Next Door,
               aperitivo hour at Bar Torino followed by dinner at Gran Torino or Gilroy Bar & Eatery.
           </h2>
       </div>
       ...
       <div class="container-fluid py-5" style="background-color:#fbf9f4;">
           <div class="d-flex justify-content-center">
               <div class="row w-100 g-5" style="max-width: 1600px;">
                   ...
                   <div class="{{ $isLastOdd ? 'col-lg-6 col-md-10' : 'col-lg-6 col-md-12' }}" id="{{ $detail['id'] }}">
                       <!-- Image -->
                       ...
                       <!-- Book Button -->
                       <div class="mt-4">
                           <a href="https://bookings.nowbookit.com/?accountid=6b8a8752-7eb2-49d7-8095-168dc2fdddc3&venueid=14008&theme=light&colors=hex,33691e,ffea00" target='_blank' class="btn custom-book-btn">BOOK A TABLE</a>
                       </div>
