<section class="private-events">
    <div class="container text-center">
        ...
        <button type="button" class="btn btn-outline-light" data-bs-toggle="modal" data-bs-target="#enquiryModal">
            ENQUIRE
        </button>
    </div>
    <!-- Enquiry Modal -->
    <div class="modal fade bg-warm" style="font-family: sans-serif;" id="enquiryModal" tabindex="-1" aria-labelledby="enquiryModalLabel" aria-hidden="true">
                ...
                <div class="modal-body"  >
                    <form method="POST" action="/send-enquiry" class="pb-3" >
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <textarea name="description" rows="7" placeholder="How Can We Help You?" required class="form-control bg-transparent"></textarea>
                            </div>
                        </div>

                        <div class="mt-4 w-100 d-flex">
                            <button type="submit" class="btn bg-transparent custom-book-btn w-100 px-5 py-2 tex-center">SUBMIT</button>
                        </div>
                    </form>
                </div>
            </div>
