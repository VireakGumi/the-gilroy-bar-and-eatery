...
<div class="container text-light py-5 mb-5 mt-5" style="max-width: 1250px;">
    <div class="row g-5 align-items-center">
        ...
        <div class="col-lg-6 col-md-12 px-4 text-center text-lg-start">
            ...
            <p class="mb-5 mt-3">
                Our delicious Italian-inspired fare comes complete with the classics you expect, and some dishes that
                will surprise and delight.
            </p>

            <div class="d-flex flex-column align-items-center align-items-lg-start">
                @foreach ($pdfMenu as $menu => $value)
                    <a href="{{ asset($value) }}" target="_blank" class="menu-link">{{ $menu }}</a>
                @endforeach
            </div>
        </div>
        ...
        <div class="col-lg-6 col-md-12">
            <div id="drinkCarousel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    @foreach ($imagesMenu as $img)
                        <div class="carousel-item {{ $loop->first ? 'active' : '' }}">
                            <img src="{{ asset($img) }}" class="d-block w-100 img-slide" alt="Mocktail">
                        </div>
                    @endforeach
                </div>
